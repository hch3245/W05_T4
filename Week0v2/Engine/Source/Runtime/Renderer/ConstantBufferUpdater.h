...
public:
    ...
    void UpdateConstant(ID3D11Buffer* ConstantBuffer, const FMatrix& M, const FMatrix& MVP, const FMatrix& NormalMatrix, FVector4 UUIDColor, bool IsSelected) const;
    ...
    void UpdateFogConstant(ID3D11Buffer* buffer, FFogConstants* fogConstant) const;
private:
