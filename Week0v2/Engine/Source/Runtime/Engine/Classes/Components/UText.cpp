...
void UText::TextMVPRendering()
{
    ...
    if (this == GetWorld()->GetPickingGizmo()) {
        UEditorEngine::renderer.GetConstantBufferUpdater().UpdateConstant(UEditorEngine::renderer.ConstantBuffer, Model, MVP, NormalMatrix, UUIDColor, true);
    }
    else
        UEditorEngine::renderer.GetConstantBufferUpdater().UpdateConstant(UEditorEngine::renderer.ConstantBuffer, Model, MVP, NormalMatrix, UUIDColor, false);
